...
public class TimestampsManagerTest extends TestCase {
	...
	public void testSerializationAndDeserialization() throws Exception {
		TimestampsManager manager = new TimestampsManager(logger,
				OUTPUT_DIRECTORY);
		...
		manager.loadPreviousTimestamps();
		assertEquals("Wrong timestamp", new Long(10), manager
				.getTimestamp("test"));
		assertEquals("Wrong timestamp", new Long(100), manager
				.getTimestamp("test2"));
	}
}
